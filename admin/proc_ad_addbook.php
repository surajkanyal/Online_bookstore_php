...
require('includes/config.php');
	...
	{
		$msg=array();
		if(empty($_POST['name']) || empty($_POST['description']) || empty($_POST['publisher'])|| empty($_POST['edition']) || empty($_POST['isbn']) || empty($_POST['price']))
		{
		...
		else
		{
			...
			$query="insert into book(b_nm,b_cat,b_desc,b_edition,b_publisher,b_isbn,b_page,b_price,b_img)
			values('$b_nm','$b_cat','$b_desc','$b_edition','$b_publisher','$b_isbn',$b_price,'$b_img')";
