...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2020 at 04:53 PM
...
INSERT INTO `book` (`b_id`, `b_nm`, `b_cat`, `b_desc`, `b_publisher`, `b_edition`, `b_isbn`, `b_price`, `b_img`) VALUES
...
INSERT INTO `contact` (`h_id`, `h_nm`, `h_email`, `h_querry`, `h_sub`) VALUES
(1, 'Hiren', 'hiru@gmail.com', 'English Novels...', '0'),
(2, 'Shital', 'shital@yahoo.com', 'Are you send me medical books?', '0'),
(3, 'Manali', 'manali@yahoo.com', 'Java Complete Reference is available?', '0'),
(4, 'Rina', 'rina@gmail.com', 'Artificial Intelligence', '0'),
(5, 'kartik', 'ramwale@gmail.com', 'rumwale ki dukan khul do bhai', 'service');
...
INSERT INTO `user` (`u_id`, `u_fnm`, `u_unm`, `u_pwd`, `u_email`, `u_contact`, `u_state`, `u_address`) VALUES
(10, 'kartik', 'kartike', 'rocks123', 'kartik123@gmail.com', '8932420523', 'Uttarakhand', 'rikahrpur'),
(4, 'admin', 'admin', 'admin', 'admin@gmail.com', '4732910273', 'karakoot', ''),
(7, 'suraj', 'simpson', '12345678', 'kskanyal@gmail.com', '8650230146', 'Uttarakhand', 'ramangar');
...
--
ALTER TABLE `contact`
  MODIFY `h_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
